...
# class ReportUploadDocuments(Document):
#     report_number = StringField(default = '')
#     report_reference_number = StringField(default = '')
#     revision_number = StringField(default = '')
#     title = StringField(default = '')
#     report_date = DateField()
#     organization_id = StringField(default = '')
#     organization_name = StringField(default = '')
...
#     last_updated_user_name = StringField()
#     last_updated_user_full_name = StringField()



# class AttachmentForReportUploadDocuments(models.Model):
#     report_upload_documents_id = models.TextField(blank=True, null=True)
#     attachment_report = models.FileField(upload_to = 'Report_Doc')
